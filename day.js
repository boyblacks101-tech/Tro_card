/* DAY CYCLE: MORNING SPAWN + END OF DAY */
(function(){
...
var due=dueCount();
mOv.innerHTML='<div style="font-size:44px">☀️</div><div style="font-family:Orbitron,sans-serif;font-size:20px;letter-spacing:4px;color:#ffd60a;text-shadow:0 0 20px #ffd60a;margin-top:8px">GOOD MORNING</div><div style="color:#98a8b8;font-size:13px;margin-top:6px">'+esc(set.name||'Hunter')+' • LV '+levelOf()+'</div><div class="swbar sta" style="width:70%;margin-top:16px"><span>EN</span><div class="tr"><i style="width:'+d.en+'%"></i></div><b>'+d.en+'%</b></div><div style="margin-top:16px;font-size:11px;letter-spacing:3px;color:var(--acc)">TODAY\'S MAIN QUEST</div><div style="color:#f2f2f7;font-size:15px;margin-top:6px;font-weight:700">'+(due>0?'Clear '+Math.min(due,20)+' reviews':'Complete the Daily Quest')+'</div><button class="btn fill" style="margin-top:20px" onclick="closeMorning()">ACCEPT ⚔️</button>';
...
var h='<div class="btitle">Day Complete</div><div style="text-align:center;font-size:44px">🌙</div>';
